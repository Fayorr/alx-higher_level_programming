...
GitHub repository: AirBnB_clone_v2 File: models/user.py
...
guillaume@ubuntu:~/AirBnB_v2$ cat main_place_amenities.py #!/usr/bin/python3 """ Test link Many-To-Many Place <> Amenity """ from models import *
